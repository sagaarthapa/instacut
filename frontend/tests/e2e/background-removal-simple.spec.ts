...
test('Background removal processing completes successfully', async ({ page }) => {
  ...
  await expect(page.locator('button:has-text("Download")').or(page.locator('text=/download/i'))).toBeVisible();
